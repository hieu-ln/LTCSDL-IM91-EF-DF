...
namespace LTCSDL_IM91_EF_DF
{
    ...
    public partial class NorthwindEntities : DbContext
    {
        ...
        public virtual DbSet<Employees_in_USA> Employees_in_USA { get; set; }
        ...
        [DbFunction("NorthwindEntities", "func_getProductByPrice")]
        public virtual IQueryable<func_getProductByPrice_Result> func_getProductByPrice(Nullable<decimal> fromAmt, Nullable<decimal> toAmt)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<func_getProductByPrice_Result>("[NorthwindEntities].[func_getProductByPrice](@fromAmt, @toAmt)", fromAmtParameter, toAmtParameter);
        }
        ...
        public virtual int PhepCong(Nullable<int> a, Nullable<int> b, ObjectParameter c)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("PhepCong", aParameter, bParameter, c);
        }
        ...
        public virtual ObjectResult<Nullable<decimal>> sp_cau12(Nullable<int> proID, ObjectParameter result)
        {
            var proIDParameter = proID.HasValue ?
                new ObjectParameter("proID", proID) :
                new ObjectParameter("proID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<decimal>>("sp_cau12", proIDParameter, result);
        }
